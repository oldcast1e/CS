...
public class MarioControllerEdit1 : MonoBehaviour
{
    ...
    void Update(){
        ...
        if (Input.GetKeyUp(KeyCode.Space) && playerRigidbody.velocity.y > 0){
            ...
            // playerRigidbody.velocity = playerRigidbody.velocity /2f;//old
            playerRigidbody.velocity = new Vector2( playerRigidbody.velocity.normalized.x , playerRigidbody.velocity.y*0.5f);
